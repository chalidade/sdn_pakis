                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body" style="text-align:left">
                                            <div class="table-responsive">
                                              <form action="app/model/SiswaModel.php?id=update&data=home" method="post" enctype="multipart/form-data">
                                              <table class="table table-border">
                                                  ...
                                                  <td rowspan="8" width="40%" style="vertical-align:middle;vertical-align:top">
                                                    <label class="" for="imgSlider1">
                                                      ...
                                                      <div class="sliderChangePicture" style="border:1px solid;background: white;width:100%;margin-top:0px;padding:0px 10px;">
                                                        ...
                                                        <input type="hidden" name="USER_PASSWORD" v-bind:value="data.USER_PASSWORD">
                                                        <input type="hidden" name="DTL_TINGKAT" v-bind:value="data.DTL_TINGKAT">
                                                        <input type="hidden" name="DTL_KELAS" v-bind:value="data.DTL_KELAS">
                                                ...
                                                <tr>
                                                  ...
                                                  <td width="1%">:</td>
                                                  <td><input type="email" name="USER_EMAIL" v-bind:value="data.USER_EMAIL" style="width: 100%;border:none;"></td>
                                                </tr>
                                                <tr>
                                                  <td width="20%" style="font-weight:800">Nomor Telpon</td>
                                                  <td width="1%">:</td>
                                                  <td><input type="text" name="DTL_PHONE" v-bind:value="data.DTL_PHONE" style="width: 100%;border:none;"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <td width="1%">:</td>
                                                  <td><input type="text" name="DTL_AYAH" v-bind:value="data.DTL_AYAH" style="width: 100%;border:none;"></td>
                                                </tr>
                                                <tr>
                                                  <td width="20%" style="font-weight:800">Nama Ibu</td>
                                                  <td width="1%">:</td>
                                                  <td><input type="text" name="DTL_IBU" v-bind:value="data.DTL_IBU" style="width: 100%;border:none;"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td colspan="4">
                                                    <textarea name="DTL_PRESTASI" rows="8" cols="60" style="border:none">{{data.DTL_PRESTASI}}</textarea>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td colspan="4">
