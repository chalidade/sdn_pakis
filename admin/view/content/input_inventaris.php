...
<div class="content-wrapper">
  ...
  <?php
  $query              = mysqli_query($mysqli, "SELECT * FROM `tx_hdr_sarpras` ORDER BY `SARPRAS__HDR_ID` DESC LIMIT 1");
  $lastId             = json_decode(json_encode(mysqli_fetch_assoc($query)),TRUE);
  $lastId             = $lastId["SARPRAS__HDR_ID"]+1;
   ?>
                  ...
                  <div class="box-body table-responsive">
                    <table width="100%" id="myTable" class="table order-list">
                      <tr>
                        ...
                        <td width="2%">:</td>
                        <td>
                          <input required type="text" class="form-control border-bottom-only" name="SARPRAS_HDR_NAMA_SEKOLAH" value="">
                          <input type="hidden" class="form-control border-bottom-only" name="SARPRAS_HDR_NO_PENGAJUAN" value="SARPRAS<?php echo date('my').$lastId; ?>">
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td width="2%">:</td>
                        <td>
                          <input required type="text" class="form-control border-bottom-only" name="SARPRAS_HDR_ALAMAT_SEKOLAH" value="">
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td width="2%">:</td>
                        <td>
                          <input required type="text" class="form-control border-bottom-only" name="SARPRAS_HDR_KECAMATAN" value="">
