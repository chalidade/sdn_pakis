    ...
    <table width="100%">
      <tr>
        <td width="50%" style="font-weight:800;vertical-align:top">
          ...
          <p>Email : <br><input type="text" name="USER_EMAIL" v-bind:value="data[0].USER_EMAIL" style="border:none"></p>
          <p>Password : <br><input type="text" name="USER_PASSWORD" v-bind:value="data[0].USER_PASSWORD" style="border:none"></p>
