                                      ...
                                      <div class="modal-dialog" style="width:80%">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" style="text-align:center">{{data.SARPRAS_HDR_NO_PENGAJUAN}}</h4>
                                          </div>
                                          <div class="modal-body" style="text-align:left">
                                              ...
                                              <div class="box-footer">
                                                <?php if($menu != 1) { ?>
                                                  <table width="100%">
                                                  <tr>
                                                    <td><button type="button" v-bind:onclick="'reject(' + data.SARPRAS__HDR_ID + ')'"/ class="btn btn-danger"  style="width:100%"> <i class="fa fa-times"></i> Reject </button></td>
                                                    <td><button type="button" v-bind:onclick="'approve(' + data.SARPRAS__HDR_ID + ')'"/ class="btn btn-success"  style="width:100%"> <i class="fa fa-check"></i> Approve </button></td>
                                                  </tr>
                                                </table>
                                               <?php } else { ?>
...
function send(id, status) {
  if (status == 0 || status == 3) {
    ...
    new Vue({
      ...
      window.location = "<?php echo $urlInventaris; ?>0&menu=1"}, 1000);
  } else {
...
function reject(id) {
  ...
  new Vue({
    ...
    window.setTimeout(function(){
    window.location = "<?php echo $urlInventaris; ?>0&menu=2"}, 1000);
}
  ...
  new Vue({
      ...
      mounted () {
        ...
        .post(url+'/index', {
            ...
            "selectraw": "A.*, C.REFF_NAME as STATUS, B.USER_NAME as STAFF",
            "start": start,
            "limit": 25
        })
