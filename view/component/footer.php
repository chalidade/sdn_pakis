  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 mb-4 mb-md-0">
        <h3 class="footer-heading mb-4 text-white">SDN PAKIS V SURABAYA</h3>
        <p>Jl. Pakis Sidokumpul No.55, Pakis, Kec. Sawahan, Kota SBY, Jawa Timur 60256<br>(031) 5665149 | sdnpakis5@yahoo.co.id</p>
      </div>
      <div class="col-md-5 mb-4 mb-md-0 ml-auto">
        <div class="row mb-4">
          ...
          <div class="col-md-6">
            <h3 class="footer-heading mb-4 text-white">Homepage</h3>
              <ul class="list-unstyled">
                <li><a href="#">Home</a></li>
